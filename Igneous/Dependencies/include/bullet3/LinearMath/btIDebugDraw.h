...
class	btIDebugDraw
{
	...
	virtual void drawTransform(const btTransform& transform, btScalar orthoLen)
	{
		...
		drawLine(start, start+transform.getBasis() * btVector3(orthoLen, 0, 0), btVector3(1.0f,0.3f,0.3f));
		drawLine(start, start+transform.getBasis() * btVector3(0, orthoLen, 0), btVector3(0.3f,1.0f, 0.3f));
		drawLine(start, start+transform.getBasis() * btVector3(0, 0, orthoLen), btVector3(0.3f, 0.3f,1.0f));
	}
